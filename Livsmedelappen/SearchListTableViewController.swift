...
class SearchListTableViewController: UITableViewController {
    ...
    var sampleDetailText = ["20 calories", "30 calories", "40 calories"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = sampleArray[indexPath.item]
        cell.detailTextLabel?.text = sampleDetailText[indexPath.item]
